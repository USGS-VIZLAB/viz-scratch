...
latest_m_flows <- "max_flows_2018-11-04T00Z.rds"

qpf_caption <- "Quantitative Precipitation Forecast (QPF) Valid: 12Z 2018-11-04 Thru 12Z 2018-11-11\n"

nwm_caption <-  paste0(qpf_caption, "NWM forecasts from 00Z 11-04")

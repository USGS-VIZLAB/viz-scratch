...
latest_m_flows <- "max_flows_2018-10-30T00Z.rds"
...
gsMap <- ggplot() +
  ...
  labs(caption = "         Quantitative Precipitation Forecast (QPF) Valid: 12Z 2018-10-30 Thru 12Z 2018-11-06\n")
